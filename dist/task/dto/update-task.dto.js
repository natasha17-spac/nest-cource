...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Completion status should not be empty' }),
    (0, class_validator_1.IsBoolean)({ message: 'Completion status must be a boolean value' }),
